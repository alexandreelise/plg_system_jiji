...
final class DeleteArticleCommand extends AbstractCommand
{
	 ...
	 * @since version
	 */
	protected static $defaultName = 'article:delete';
	...
	{
		$this->setDescription('Delete article using cli');
		$this->setHelp("<info>%command.name%</info> Delete an entity by id \n type the entity name as argument after the command.\n For example: <info>%command.name%</info> article:delete \n");
